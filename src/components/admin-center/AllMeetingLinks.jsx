      ...
      <div className=" mt-5 px-2">
        <div className=" flex flex-col gap-2 mt-4">
          {defaultMeetLink && defaultMeetLink.mode ? (
            <div className=" bg-gray-100   w-full flex gap-2 items-center justify-between px-2">
              <div className=" flex flex-col font-poppins">
                <p className=" p-2">{defaultMeetLink.mode}</p>
                <p className=" p-2">{defaultMeetLink.meetingLink}</p>
              </div>
              <Trash2
